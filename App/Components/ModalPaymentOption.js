...
class ModalPaymentOption extends React.Component {
                        ...
                        <View style={style.body}>
                            <View style={{padding:Metrics.pdb}}>
                                <View style={{marginBottom:Metrics.mdb,justifyContent:'center',alignItems:'center'}}>
                                    <Image source={require('../Images/credit_card.png')} style={{width:100,height:100}} resizeMode='contain' />
                                </View>
                                <Text center>Payment with credit card?</Text>
                            </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalPaymentOption)