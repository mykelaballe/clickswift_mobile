...
class ModalWaiterSelect extends React.Component {
                ...
                <View style={style.modal}>
                    <View style={style.container}>
                        ...
                        <View style={style.header}>
                            <Text light bold center>Choose an account</Text>
                        </View>

                        <View style={style.body}>

                            <View style={{padding:Metrics.pdb}}>
                                <Button text="Redirection to waiter's account" type='branding' onPress={props.onRequestClose} mv/>
                                <Button text="Redirect to hookah - master's account" type='branding' onPress={props.onRequestClose} mv/>
                            </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalWaiterSelect)