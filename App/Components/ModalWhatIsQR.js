...
class ModalWhatIsQR extends React.Component {
                ...
                <View style={style.modal}>
                    <View style={style.container}>
                        <View style={style.header}>
                            <Text light center bold>WHAT IS QR-CODE?</Text>
                        </View>
                        <View style={style.body}>
                            <View style={{padding:Metrics.pdb}}>
                                <View style={{marginBottom:Metrics.mdb,justifyContent:'center',alignItems:'center'}}>
                                    <Image source={require('../Images/qr_code.png')} style={{width:100,height:100}} resizeMode='contain' />
                                </View>
                                <Text sm mute center>
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalWhatIsQR)